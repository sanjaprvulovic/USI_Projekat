          ...
          <form method="POST" action="{{ route('degustacioni-pakets.update', $degustacioni_paket) }}">
            ...
            <div class="mb-3">
              ...
              <input type="number" min="0" step="1" id="Cena" name="Cena"
                     value="{{ old('Cena', $degustacioni_paket->Cena) }}"
            ...
            <div class="mb-3">
              ...
              <textarea id="Opis" name="Opis" rows="4"
                        ...
                        placeholder="Šta je uključeno u paket…">{{ old('Opis', $degustacioni_paket->Opis) }}</textarea>
